...
public class Peminjaman extends javax.swing.JFrame {
    ...
    private void otomatis() {
        try {
            ...
            while (res.next()) {
                if (res.first() == false) {
                    txtKP.setText("NPU/" + blnth + "/" + "000001");
                } else {
                    res.last();
    ...
    private void noterakhir() {
        try {
            ...
            if (!res.next()) {
                txtKP.setText("NPU/" + blnth + "/" + "000000");
            } else {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA PEMINJAMAN BUKU PERPUSTAKAAN NPU");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data Peminjam", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 3)); // NOI18N
    ...
    private void txtKodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtKodeActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM Buku where kode ='" + txtKode.getText() + "'";
            java.sql.Connection conn = (Connection) Koneksi.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
